...
Tria *createTriangleByPoints(PtCord *point1, PtCord *point2, PtCord *point3)
{
    ...
    {
        printf("Some line was NULL.\n");

        free(triangle);
        return NULL;
    }
    else if (lenghtLine(Line1_3) + lenghtLine(Line2_3) <= lenghtLine(Line1_2) ||

             lenghtLine(Line1_3) + lenghtLine(Line1_2) <= lenghtLine(Line2_3) ||

             lenghtLine(Line1_2) + lenghtLine(Line2_3) <= lenghtLine(Line1_3)){

                printf("Wrong sides of triangle.\n");
                free(triangle);
                return NULL;
             }
